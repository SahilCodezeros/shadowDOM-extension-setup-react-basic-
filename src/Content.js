  ...
  openMenu = async (type, previewId, closeContinue) => {
    ...
    switch (type) {
      ...
      case "preview":
        ...
        chrome.storage.local.get(
          ["trail_web_user_tour", "userData", "isPreview"],
          async function (items) {
            if (items.isPreview) {
              document
                .getElementById("extension-div")
                .shadowRoot.querySelector(".menu.pop").style.display = "none";
            }
        ...
        <div id="my-extension-root">
          <div className={"my-extension"}>
            ...
            <div className={`wrap ${menuOpen ? "open" : ""}`}>
              ...
              >
                ...
                >
                  <g
                    id="Group_471"
                    data-name="Group 471"
                    transform="translate(11703 4613)"
                  >
                    <circle
                      id="Ellipse_101"
                    ...
                    <g id="visibility" transform="translate(-11694 -4688.449)">
                      ...
                      >
                        ...
                        >
                          <path
                            id="Path_103"
                            data-name="Path 103"
                            d="M28.032,98.985c-2.049-5.106-7.668-8.536-13.983-8.536S2.116,93.879.066,98.985a.915.915,0,0,0,0,.682c2.051,5.105,7.671,8.535,13.983,8.535s11.931-3.43,13.983-8.535A.915.915,0,0,0,28.032,98.985Zm-13.983,7.387c-5.428,0-10.253-2.817-12.141-7.047,1.886-4.23,6.711-7.046,12.141-7.046S24.3,95.1,26.19,99.325C24.3,103.555,19.477,106.372,14.049,106.372Z"
                            transform="translate(0 -90.449)"
                            fill="#fb542b"
                            className="svg_btn"
                            stroke="#fff"
                      ...
                      <g
                        id="Group_280"
                        data-name="Group 280"
                        transform="translate(8.66 93.987)"
                      >
                        <g
                          id="Group_279"
                          data-name="Group 279"
                        ...
                        >
                          <path
                            id="Path_104"
                            data-name="Path 104"
                            d="M156.762,152.32a5.338,5.338,0,1,0,5.338,5.338A5.344,5.344,0,0,0,156.762,152.32Zm0,8.846a3.508,3.508,0,1,1,3.508-3.508A3.512,3.512,0,0,1,156.762,161.166Z"
                            transform="translate(-151.424 -152.32)"
                            fill="#fb542b"
                            className="svg_btn"
                            stroke="#fff"
                            stroke-width="0.5"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <g
                      id="drawing-tablet"
                      transform="translate(-11693.5 -4603)"
                    >
                      <path
                        id="Path_105"
                        data-name="Path 105"
                        d="M293.045,393.1a.549.549,0,1,0-.549-.549A.549.549,0,0,0,293.045,393.1Zm0,0"
                        transform="translate(-275.972 -370.488)"
                        fill="#fb542b"
                        className="svg_btn2"
                        stroke="#fb542b"
                        stroke-width="0.25"
                      ...
                      <path
                        id="Path_108"
                        data-name="Path 108"
                        d="M333.041,317.492h3.293a.549.549,0,0,0,.549-.549v-4.39a.549.549,0,1,0-1.1,0v3.841h-2.744a.549.549,0,0,0,0,1.1Zm0,0"
                        transform="translate(-313.773 -294.882)"
                        fill="#fb542b"
                        className="svg_btn2"
                        stroke="#fb542b"
                        stroke-width="0.25"
              ...
              <button
                class="blob"
                onClick={(e) => this.openMenu("modal")}
                data-title="Create Modal"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="48"
                  ...
                  >
                    ...
                    <g id="interface" transform="translate(-11693 -4602)">
                      <path
                        ...
                        id="Path_1"
                        data-name="Path 1"
                        d="M0,6.186V25.2H27.657V1H0ZM24.2,2.729h1.729V4.457H24.2ZM1.729,6.186h24.2V23.471H1.729Z"
                        fill="#fb542b"
                      />
                      <path
                        className="svg_btn"
                        id="Path_2"
                        data-name="Path 2"
                        d="M3,6H6.457V7.729H3Z"
                        transform="translate(2.186 3.643)"
                        fill="#fb542b"
                      />
                      <path
                        className="svg_btn"
                        id="Path_3"
                        data-name="Path 3"
                        d="M6,6H18.1V7.729H6Z"
                        transform="translate(4.371 3.643)"
                        fill="#fb542b"
                      />
                      <path
                        className="svg_btn"
                        id="Path_4"
                        data-name="Path 4"
                        d="M3,8H6.457V9.729H3Z"
                        transform="translate(2.186 5.1)"
                        fill="#fb542b"
                      />
                      <path
                        className="svg_btn"
                        id="Path_5"
                        data-name="Path 5"
                        d="M6,8H18.1V9.729H6Z"
                        transform="translate(4.371 5.1)"
                        fill="#fb542b"
                      />
                      <path
                        className="svg_btn"
                        id="Path_6"
                        data-name="Path 6"
                        d="M3,10H6.457v1.729H3Z"
                        transform="translate(2.186 6.557)"
                        fill="#fb542b"
                      />
                      <path
                        className="svg_btn"
                        id="Path_7"
                        data-name="Path 7"
                        d="M6,10H18.1v1.729H6Z"
                        transform="translate(4.371 6.557)"
                        fill="#fb542b"
                      />
                    </g>
                  </g>
              ...
              <button className="menu" onClick={(e) => this.openMenu("")}>
                <img
                  className="trail_plus"
                  alt=""
                  src={require("./images/imgpsh_fullsize_anim.png")}
                />
                <img
                  className="trail_edit"
                  src={require(`./images/edit-tools.png`)}
                />
              </button>
              {!document.URL.includes("https://twitter.com") && (
                <React.Fragment>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <g
                          id="video-camera-side-view-outlined-tool-symbol"
                          transform="translate(1832 502.041)"
                        >
                          <g
                            id="Group_281"
                            data-name="Group 281"
                            transform="translate(0 111.272)"
                          >
                            <path
                              id="Path_109"
                              data-name="Path 109"
                              d="M15.317,126.681a2.156,2.156,0,0,0,2.2-2.2V113.473a2.156,2.156,0,0,0-2.2-2.2H2.2a2.156,2.156,0,0,0-2.2,2.2V124.48a2.156,2.156,0,0,0,2.2,2.2ZM1.1,124.459V113.493a1.092,1.092,0,0,1,1.113-1.12H15.431a1.092,1.092,0,0,1,1.113,1.12v10.966a1.093,1.093,0,0,1-1.113,1.122H2.213A1.093,1.093,0,0,1,1.1,124.459Z"
                              transform="translate(0 -111.272)"
                              fill="#fb542b"
                              className="svg_btn2"
                              stroke="#fb542b"
                            ...
                            <path
                              id="Path_110"
                              data-name="Path 110"
                              d="M475.162,121.072v1.348l5.414,4.261V111.272l-5.414,4.3v1.379l4.313-3.236v10.592Z"
                              transform="translate(-456.362 -111.272)"
                              fill="#fb542b"
                              className="svg_btn2"
                              stroke="#fb542b"
                              stroke-width="0.2"
                    ...
                    >
                      ...
                      <g id="edit" transform="translate(-11683.37 -4600.589)">
                        <path
                          ...
                          className="svg_btn2"
                          data-name="Path 1"
                          d="M18.7,49.861a.5.5,0,0,0-.5.5v4.481a1.515,1.515,0,0,1-1.514,1.514H2.523a1.515,1.515,0,0,1-1.514-1.514V41.7a1.516,1.516,0,0,1,1.514-1.514H7a.5.5,0,0,0,0-1.009H2.523A2.526,2.526,0,0,0,0,41.7V54.846A2.526,2.526,0,0,0,2.523,57.37h14.16a2.526,2.526,0,0,0,2.523-2.523V50.365a.5.5,0,0,0-.5-.5Zm0,0"
                        ...
                        <path
                          ...
                          className="svg_btn2"
                          data-name="Path 2"
                          d="M121.737.926a2.271,2.271,0,0,0-3.212,0l-9,9a.5.5,0,0,0-.13.222l-1.184,4.274a.5.5,0,0,0,.621.621l4.274-1.184a.5.5,0,0,0,.222-.13l9-9a2.273,2.273,0,0,0,0-3.212Zm-11.115,9.331,7.369-7.369,2.376,2.376L113,12.634Zm-.475.953,1.9,1.9-2.626.728Zm11.469-7.194-.535.535L118.7,2.175l.535-.535a1.262,1.262,0,0,1,1.784,0l.592.592A1.263,1.263,0,0,1,121.616,4.016Zm0,0"
        ...
        <div id="my-extension-defaultroot">
          ...
          <div className="sidepanal adadad trail_sidepanel_overlay">
                    ...
                    <div className="pl-4 trail_video_frm">
                      ...
                      {tourStatus === "preview" && tourType === "video" && (
                        <input
                          type="submit"
                          onClick={() =>
                            this.onTourVideoTrail(this.state.tourStep - 1)
                          }
                          value="Previous"
                      ...
                      >
                        {this.state.trailList.map((result, index) => (
                          <SortableItem
                            ...
                            MobileTargetNotFound={
                              this.state.MobileTargetNotFound
                            }
                          />
                        ))}
                      </SortableContainer>
            ...
            <button className="menu pop" onClick={this.openPopup}>
              <img alt="" src={require("./images/imgpsh_fullsize_anim.png")} />
            </button>
          </div>
        </div>
      </>
